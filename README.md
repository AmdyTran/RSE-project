...
In the
[online](https://gitlab.inf.ethz.ch/COURSE-RSE-2023/really-serious-engineers#pipeline-status)
version of this file, you can see the current status of the project.

Current pipeline status: ![pipeline
status](https://gitlab.inf.ethz.ch/COURSE-RSE-2023/really-serious-engineers/badges/master/pipeline.svg)

Current code coverage: ![code coverage](https://gitlab.inf.ethz.ch/COURSE-RSE-2023/really-serious-engineers/badges/master/coverage.svg)
